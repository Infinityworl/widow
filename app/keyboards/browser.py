...
def qualities_keyboard(settings, title_id: str, qualities: Iterable[str], *, season: int | None = None, episode: int | None = None, page: int = 0, page_size: int = SELECTOR_PAGE_SIZE) -> InlineKeyboardMarkup:
